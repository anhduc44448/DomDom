...
function displayProduct(product) {
  ...
  const discountS = formatPrice(Math.round(product.price * 0.1));
  const extraL = formatPrice(Math.round(product.price * 0.2));
                        ...
                        <div class="mb-3">
                            ...
                            <div class="size-options">
                                <label class="size-option">
                                    ...
                                    <span class="size-price">-${discountS}đ</span>
                                </label>
                                ...
                                <label class="size-option">
                                    ...
                                    <span class="size-price">+${extraL}đ</span>
                                </label>
                            </div>
                        </div>
                    </div>
...
function initOrderControls(product) {
  ...
  function updateTotalPrice() {
    ...
    if (size === "S") sizeMultiplier = 0.9;
    if (size === "L") sizeMultiplier = 1.2;

    const sizeExtra = Math.round(basePrice * (sizeMultiplier - 1));
    const total = Math.round(basePrice * sizeMultiplier) * quantity;
